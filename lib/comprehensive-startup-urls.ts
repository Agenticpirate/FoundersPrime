/**
 * Comprehensive manual mapping of providers to their ACTUAL startup program URLs
 * These are the EXACT pages where startups should apply, not generic homepages
...
export const startupProgramUrls: { [key: string]: string } = {
  ...
  'microsoft azure': 'https://azure.microsoft.com/en-us/pricing/offers/ms-azr-0036p/',
