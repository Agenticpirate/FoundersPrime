...
import { sanitizeStaticHtml } from '@/lib/safe-html'
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      {sections.map((section, index) => (
        <div key={section.id} id={section.id} className="scroll-mt-20 bg-white dark:bg-[#09090b]/90 border border-gray-200 dark:border-neutral-900 shadow-sm dark:shadow-[0_8px_30px_rgb(0,0,0,0.5)] rounded-xl backdrop-blur-md p-4 md:p-6 transition-colors duration-300">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: sanitizeStaticHtml(section.content) }}
          />
        </div>
      ))}
