  ...
  const socials = [
    {
      ...
      bg: 'hover:bg-white/10 hover:border-white hover:shadow-[0_0_12px_rgba(255,255,255,0.2)]',
      svg: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" fill="currentColor" aria-hidden>
    ...
    },
    {
      ...
      bg: 'hover:bg-[#0A66C2]/10 hover:border-[#0A66C2] hover:shadow-[0_0_12px_rgba(10,102,194,0.3)]',
      svg: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" fill="currentColor" aria-hidden>
          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.852 3.37-1.852 3.601 0 4.267 2.37 4.267 5.455v6.288zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.063 2.063 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
        </svg>
      ),
      iconColor: 'text-gray-400 group-hover:text-[#0A66C2]',
    },
    {
      label: 'Discord',
      href: '#',
      bg: 'hover:bg-[#5865F2]/10 hover:border-[#5865F2] hover:shadow-[0_0_12px_rgba(88,101,242,0.3)]',
      svg: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" fill="currentColor" aria-hidden>
      ...
      iconColor: 'text-gray-400 group-hover:text-[#5865F2]',
    },
    {
      label: 'Email',
      href: 'mailto:hello@foundersprime.com',
      bg: 'hover:bg-accent-yellow/10 hover:border-accent-yellow hover:shadow-[0_0_12px_rgba(255,215,0,0.3)]',
      svg: (
        <svg viewBox="0 0 24 24" className="w-4 h-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6" fill="currentColor" aria-hidden>
      ...
      iconColor: 'text-gray-400 group-hover:text-accent-yellow',
    },
  ]
            ...
            <div className="flex items-center gap-2.5 mt-2 w-full">
              {socials.map((s) => (
                <a
                  ...
                  className={`group flex-1 h-11 bg-white/5 border border-white/15 rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5 hover:border-white/40 active:scale-95 active:translate-y-0 ${s.bg}`}
                >
