        ...
        <div className="w-full">
            ...
            {paginatedDeals.length > 0 ? (
                <>
                    ...
                    {totalPages > 1 && (
                        <div className="w-full border-2 border-black p-2 flex justify-between items-center bg-white mb-10 mt-10 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            {/* Previous */}
                            <button
                                disabled={currentPage === 1}
                                onClick={() => handlePageChange(currentPage - 1)}
                                className="px-4 py-2 border-2 border-black font-mono text-sm font-bold flex items-center gap-2 hover:bg-gray-100 disabled:opacity-50 disabled:hover:bg-white transition-colors"
                            >
                                ...
                                {getPaginationRange(currentPage, totalPages).map((p, i) => (
                                    typeof p === 'number' ? (
                                        <button
                                            ...
                                            className={`w-10 h-10 border-2 border-black font-mono text-sm font-bold flex items-center justify-center transition-all ${currentPage === p
                                        ...
                                        <span key={i} className="w-10 h-10 flex items-center justify-center font-mono font-bold text-black">...</span>
                                    )
                                ))}
                            </div>
                            {/* Mobile Page Display */}
                            <div className="sm:hidden font-mono text-sm font-bold">
                            ...
                            <button
                                ...
                                onClick={() => handlePageChange(currentPage + 1)}
                                className="px-4 py-2 border-2 border-black bg-[#00D4FF] text-black font-mono text-sm font-bold flex items-center gap-2 hover:bg-[#00B8E6] disabled:opacity-50 disabled:bg-gray-300 transition-colors shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
                            >
                                Next
