    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 mb-4 md:mb-12">
        ...
        <div className="bg-white border-2 border-black shadow-[3px_3px_0px_0px_#1a1a1a] md:shadow-[4px_4px_0px_0px_#1a1a1a] rounded-sm p-4 md:p-8 relative overflow-hidden">
          ...
          <div className="prose prose-neutral max-w-none">
            <h3 className="font-mono text-lg font-bold uppercase mb-3 text-primary bg-black inline-block px-2 text-white">
              The Landscape in Q1 2026
            </h3>
            <p className="font-sans text-gray-700 mb-4 text-base">
              The global startup accelerator ecosystem in January 2026 reflects a stabilized and highly professionalized market.
              The surviving and active accelerators have bifurcated into two dominant archetypes: Global Asset Managers (serving as index funds) and Vertical Specialists.
            </p>

            <div className="bg-gray-100 border-2 border-dashed border-gray-400 p-4 rounded-sm mb-6">
              <p className="font-mono text-xs font-bold text-gray-500 uppercase mb-3">Key Trends 2026</p>
      ...
      <div className="lg:col-span-4 space-y-3 md:space-y-4">
        ...
        <div className="bg-black text-white border-2 border-black shadow-[4px_4px_0px_0px_#1a1a1a] rounded-sm p-6">
          <h3 className="font-mono text-lg font-bold mb-3 text-primary">2026 Deal Terms</h3>
