    ...
    return (
        <div className="mb-8">
            ...
            <div className="mb-6 relative">
                <div className="inline-block border-2 border-black bg-accent-yellow px-3 py-1 font-mono text-xs font-bold uppercase tracking-wide rounded-sm mb-3 shadow-[2px_2px_0px_0px_#1a1a1a]">
                    Verified Opportunities
                </div>
                <h1 className="font-mono text-4xl md:text-5xl font-black tracking-tight text-black mb-4 leading-none">
                    Startup Deals & Credits
                </h1>
                <p className="font-sans text-lg text-gray-700 leading-relaxed max-w-3xl border-l-4 border-black pl-4">
