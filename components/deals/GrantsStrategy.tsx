export default function GrantsStrategy() {
 ...
 <div>
 <h2 className="text-lg md:text-3xl font-black mb-1 md:mb-2 text-black">Strategic Insight: Grant Landscape</h2>
 ...
 <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
 Grants are highly competitive, requiring startups to demonstrate not just innovative capacity but tangible pathways to commercialization and societal impact.
 </p>
 </div>
