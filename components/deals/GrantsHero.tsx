  ...
  return (
    <div className="mb-12">
      ...
      <div className="mb-6">
        ...
        <h1 className="font-mono text-4xl md:text-5xl font-bold tracking-tight text-black mb-3 leading-tight">
          Startup Grants & Competitions
        </h1>
        <p className="font-sans text-base text-gray-700 leading-relaxed max-w-3xl">
          Access <span className="font-bold text-black bg-primary/20 px-1">{totalGrants} active grants</span> from government agencies, foundations, and global competitions. Get funded without giving up equity—from $10K micro-grants to $100M+ prize competitions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white border-2 border-black shadow-[3px_3px_0px_0px_#1a1a1a] rounded-sm p-4 flex items-center justify-between hover:shadow-[4px_4px_0px_0px_#1a1a1a] hover:-translate-x-px hover:-translate-y-px transition-all">
          <div>
            ...
            <p className="font-mono text-2xl font-bold text-black">{totalGrants}</p>
          </div>
          <span className="material-symbols-outlined text-2xl text-black">workspace_premium</span>
        </div>
        ...
        <div className="bg-black text-white border-2 border-black shadow-[3px_3px_0px_0px_#1a1a1a] rounded-sm p-4 flex items-center justify-between hover:shadow-[4px_4px_0px_0px_#1a1a1a] hover:-translate-x-px hover:-translate-y-px transition-all">
          <div>
            <p className="font-mono text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Total Funding</p>
            <p className="font-mono text-2xl font-bold text-white">$237M+</p>
          </div>
        ...
        <div className="bg-white border-2 border-black shadow-[3px_3px_0px_0px_#1a1a1a] rounded-sm p-4 flex items-center justify-between hover:shadow-[4px_4px_0px_0px_#1a1a1a] hover:-translate-x-px hover:-translate-y-px transition-all">
          <div>
            <p className="font-mono text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Equity Required</p>
            <p className="font-mono text-2xl font-bold text-black">0%</p>
          </div>
          <span className="material-symbols-outlined text-2xl text-black">block</span>
        </div>
      </div>
    </div>
  )
