export default function WorkflowProtocol() {
  ...
  return (
    <section className="relative py-14 border-b-2 border-black grid-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-black mb-4 leading-tight font-sans">
            From discovery to action<br />in minutes.
          </h2>
          <p className="text-lg text-gray-600 font-medium max-w-2xl mx-auto font-mono">
