...
export const metadata: Metadata = {
  title: 'Refund Policy',
  description: 'FoundersPrime refund policy. Read our policy regarding subscriptions, credits, and final sales.',
}

export default function RefundPolicyPage() {
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-[#050505]">
      <Header />
