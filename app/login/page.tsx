...
function LoginContent() {
  ...
  const handleToggleView = (newView: 'login' | 'signup' | 'forgot') => {
    setError(null)
    setSuccessMsg(null)
  ...
  return (
    <div className="min-h-screen flex bg-[#000000] grid-bg-dark text-white selection:bg-accent-yellow selection:text-black relative overflow-hidden">
      ...
      {/* Left Panel — Branding */}
      <div className="hidden lg:flex lg:w-[45%] border-r border-white/5 text-white flex-col justify-between p-8 xl:p-12 relative overflow-hidden backdrop-blur-sm">
        <div className="relative z-10">
          <div className="flex flex-col gap-5 mb-6">
            <Link href="/" className="inline-flex items-center gap-2.5 no-underline group self-start">
              <div className="bg-[#0c0c0c] border border-white/15 p-1.5 rounded-xl flex items-center justify-center h-10 w-10 shadow-sm transition-all overflow-hidden flex-shrink-0">
                <img
                  src="/logo-icon.png"
                  alt="FoundersPrime"
              ...
              <span className="font-mono font-black text-xl tracking-[0.18em] uppercase whitespace-nowrap text-white">
                FOUNDERS<span className="text-accent-yellow">[</span>PRIME<span className="text-accent-yellow">]</span>
              </span>
            </Link>

            <div className="inline-flex items-center gap-2 bg-neutral-900/80 border border-neutral-800 rounded-full px-3 py-1 self-start text-[10px] font-mono">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-sm mb-6 font-sans">
            Ship in days, not weeks. Stop burning precious capital on your stack when you can leverage <span className="text-accent-yellow font-bold font-mono">up to $500K+</span> in verified startup credits, non-dilutive grants, and exclusive founder perks. Plug into the FoundersPrime terminal today.
          </p>
        ...
        <div className="relative z-10 mt-4 space-y-4">
          <div className="bg-neutral-900/30 border border-neutral-900 p-4 rounded-xl relative max-w-sm testimonial-card cursor-default">
            <div className="absolute inset-0 bg-gradient-to-br from-accent-yellow/5 to-transparent opacity-0 transition-opacity duration-500 rounded-xl hover-glow"></div>
            <span className="font-mono text-3xl leading-none text-accent-yellow/30 font-black absolute top-1 left-2 transition-colors duration-500 quote-mark">&ldquo;</span>
            <p className="text-xs text-gray-300 leading-relaxed mb-3 pl-4 relative z-10 transition-colors duration-300 hover:text-white">
              FoundersPrime helped us access $120K in cloud credits and cut our infra costs by 80%.
            </p>
            <div className="flex items-center gap-2.5 pl-4 border-t border-neutral-900/60 pt-3 relative z-10">
              <img
                src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=80&h=80&q=80"
                alt="Arjun Malhotra"
                className="w-7 h-7 rounded-full object-cover border border-neutral-800 transition-transform duration-500 avatar-img"
              />
              <div>
                <div className="flex items-center gap-1">
                  <h4 className="text-[10px] font-black text-white uppercase tracking-wider font-mono">Arjun Malhotra</h4>
                  <span className="material-symbols-outlined text-[10px] text-accent-yellow" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                </div>
                <p className="text-[9px] text-gray-500 font-mono leading-none">Founder, QuickBuild</p>
              </div>
            </div>
          </div>

          <div className="pt-4 border-t border-neutral-900 overflow-hidden">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex-1 h-px bg-neutral-900" />
              <span className="text-[9px] font-mono font-bold text-gray-500 uppercase tracking-widest whitespace-nowrap">TRUSTED BY FOUNDERS WHO USE</span>
              <div className="flex-1 h-px bg-neutral-900" />
            </div>
      ...
      {/* Right Panel */}
      <div className="flex-1 flex flex-col relative overflow-hidden justify-center items-center px-4 py-8 md:px-8">
        
        <div className="w-full max-w-[380px] login-fade-up relative z-10">
          <div className="bg-[#09090b]/80 border border-white/5 rounded-xl px-5 py-4.5 shadow-[0_8px_30px_rgb(0,0,0,0.5)] backdrop-blur-2xl relative overflow-hidden">
            ...
            {view === 'login' && (
              <>
                <div className="mb-3.5">
                  <h1 className="text-xl font-black uppercase font-mono mb-1 tracking-tight text-white">
                    Welcome back, <span className="text-accent-yellow">founder.</span>
                  </h1>
                  <p className="text-gray-400 text-[10px] font-mono">Sign in to your account to continue</p>
                </div>

                {/* OAuth buttons */}
                <div className="grid grid-cols-3 gap-2 mb-3 font-mono text-[9px] font-bold uppercase">
                  <button onClick={() => handleOAuthLogin('google')} disabled={loading} className="h-9 border border-white/5 bg-white/[0.02] hover:bg-white/5 text-gray-300 rounded flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 hover:border-white/10">
                  ...
                  <button onClick={() => handleOAuthLogin('github')} disabled={loading} className="h-9 border border-white/5 bg-white/[0.02] hover:bg-white/5 text-gray-300 rounded flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 hover:border-white/10">
                  ...
                  <button onClick={() => handleOAuthLogin('linkedin')} disabled={loading} className="h-9 border border-white/5 bg-white/[0.02] hover:bg-white/5 text-gray-300 rounded flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 hover:border-white/10">
                ...
                <form onSubmit={handleSignInSubmit} className="space-y-2.5">
                  <div>
                    <label htmlFor="email" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Email Address</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-10 pl-10 pr-4 border border-neutral-800 bg-[#0c0c0e] text-white text-xs font-medium placeholder:text-gray-600 focus:bg-black focus:border-accent-yellow/50 outline-none rounded transition-all"
                  ...
                  <div>
                    <label htmlFor="current-password" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Password</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-10 pl-10 pr-10 border border-neutral-800 bg-[#0c0c0e] text-white text-xs font-medium placeholder:text-gray-600 focus:bg-black focus:border-accent-yellow/50 outline-none rounded transition-all"
                        placeholder="••••••••"
                        required
                        disabled={loading}
                      />
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                      <input type="checkbox" className="w-3.5 h-3.5 border border-neutral-800 bg-[#0c0c0e] accent-accent-yellow rounded" />
                      <span className="text-[11px] font-medium text-gray-400">Remember me</span>
                    </label>
            ...
            {view === 'signup' && (
              <>
                <div className="mb-3.5">
                  ...
                  <p className="text-gray-400 text-[10px] font-mono">Unlock the premium startup database</p>
                </div>

                <form onSubmit={handleSignupSubmit} className="space-y-2.5">
                  <div>
                    <label htmlFor="fullname" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Full Name</label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="new-password" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Password</label>
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 text-sm">lock</span>
                      <input
                        type={showPassword ? "text" : "password"}
                  ...
                  <div className="flex items-start gap-2.5">
                    <input
                      ...
                      className="w-3.5 h-3.5 mt-0.5 border border-neutral-800 bg-[#0c0c0e] accent-accent-yellow rounded"
                      required
                    />
                    <label htmlFor="agree" className="text-[11px] font-medium text-gray-400 leading-normal">
            ...
            {view === 'forgot' && (
              <>
                <div className="mb-3.5">
                  ...
                  <p className="text-gray-400 text-[10px] font-mono">We will send you a secure recovery link</p>
                </div>

                <form onSubmit={handleForgotSubmit} className="space-y-2.5">
                  <div>
                    <label htmlFor="forgot-email" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Email Address</label>
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 text-sm">mail</span>
                      <input
                        type="email"
            ...
            {view === 'mfa' && (
              <>
                <div className="mb-3.5">
                  ...
                  <p className="text-gray-400 text-[10px] font-mono">Enter the 6-digit code from your authenticator app</p>
                </div>

                <form onSubmit={handleMfaVerify} className="space-y-2.5">
                  <div>
                    <label htmlFor="mfa-code" className="block text-[10px] font-bold uppercase tracking-wider font-mono mb-1.5 text-gray-400">Verification Code</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-11 pl-10 pr-4 border border-neutral-800 bg-[#0c0c0e] text-white text-center text-lg font-mono tracking-[0.3em] placeholder:text-gray-700 focus:bg-black focus:border-accent-yellow/50 outline-none rounded transition-all"
                        placeholder="000000"
                        required
                        disabled={loading}
                      />
            ...
            <div className="mt-3.5 p-2.5 bg-neutral-950/80 border border-neutral-900/50 rounded flex items-start gap-2 text-[10px] text-gray-400 font-mono leading-normal">
          ...
          {/* Right Panel Footer */}
          <div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-2.5 max-w-sm mx-auto font-mono text-[9px] text-gray-500 uppercase tracking-wider">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-accent-yellow text-sm">verified</span>
              <div>
                <p className="font-bold text-gray-400 text-[10px]">Vetted Deals Only</p>
                <p className="text-[8px] text-gray-600 lowercase tracking-normal">100% verified status</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-accent-yellow text-sm">bolt</span>
              <div>
                <p className="font-bold text-gray-400 text-[10px]">Instant Access</p>
                <p className="text-[8px] text-gray-600 lowercase tracking-normal">Start in 60 seconds</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-accent-yellow text-sm">lock</span>
              <div>
                <p className="font-bold text-gray-400 text-[10px]">Secure & Encrypted</p>
                <p className="text-[8px] text-gray-600 lowercase tracking-normal">Your data is protected</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-accent-yellow text-sm">workspace_premium</span>
              <div>
                <p className="font-bold text-gray-400 text-[10px]">Zero Dilution</p>
                <p className="text-[8px] text-gray-600 lowercase tracking-normal">No equity, ever</p>
              </div>
            </div>
          </div>
