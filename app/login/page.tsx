...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#000000] grid-bg-dark text-white selection:bg-accent-yellow selection:text-black relative">
      <Header />
        ...
        <div className="max-w-[1100px] w-full mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 col-span-12 flex flex-col justify-center items-center relative">
            <div className="w-full max-w-[380px] login-fade-up relative z-10">
              <div className="bg-[#09090b]/80 border border-white/5 rounded-xl px-5 py-5 shadow-[0_8px_30px_rgb(0,0,0,0.5)] backdrop-blur-2xl relative overflow-hidden">
