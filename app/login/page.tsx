  ...
  useEffect(() => {
    ...
    const initGoogleGSI = () => {
      ...
      if (g && g.accounts && g.accounts.id) {
        ...
        // Triggers the Google One Tap premium floating prompt
    ...
    // Mutation observer to re-run initialisation if React switches views or redraws DOM
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3 font-mono text-[9px] font-bold uppercase">
                      <button type="button" disabled={loading} className="relative overflow-hidden h-9 border border-gray-200 dark:border-white/5 bg-gray-50 dark:bg-white/[0.02] hover:bg-gray-100 dark:hover:bg-white/5 text-gray-600 dark:text-gray-300 rounded flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 hover:border-gray-300 dark:hover:border-white/10">
                        ...
                        Google
                        <div id="google-login-btn" className="absolute inset-0 opacity-0 scale-[3] origin-center cursor-pointer" />
                      </button>
