...
export default function SubmitDealPage() {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-white dark:bg-[#000000] text-gray-900 dark:text-white transition-colors duration-300">
            <Header />
            ...
            <main className="flex-1 pattern-grid-lg py-12 md:py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-10 md:mb-12 text-center">
                        ...
                        <h1 className="font-heading text-3xl md:text-5xl font-black uppercase mb-3 tracking-tight text-gray-900 dark:text-white">
                            Submit Your <span className="text-yellow-400">Deal</span>
                        </h1>
                        <p className="font-sans text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed">
                    ...
                    {submissionStatus === 'success' ? (
                        <motion.div
                            ...
                            className="relative bg-white dark:bg-[#0d0d0d] border border-gray-200 dark:border-zinc-800 rounded-2xl p-6 md:p-12 text-center overflow-hidden shadow-xl dark:shadow-2xl"
                        >
                            ...
                            >
                                {(submittedTier === 'featured'
                                    ...
                                    <motion.li
                                        ...
                                        className="flex gap-4 bg-gray-50 dark:bg-[#111115] border border-gray-200 dark:border-zinc-800/60 p-4 rounded-xl hover:border-gray-300 dark:hover:border-zinc-800 transition-colors"
                                    >
                        ...
                        <form className="relative bg-white dark:bg-[#0d0d0d] border border-gray-200 dark:border-zinc-800 rounded-2xl p-6 md:p-10 space-y-8 md:space-y-10 shadow-xl dark:shadow-2xl" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 border-b border-gray-200 dark:border-zinc-800 pb-3">
                                    ...
                                    <div>
                                        <h2 className="font-heading text-sm font-bold uppercase tracking-wider text-gray-900 dark:text-white">Provider Details</h2>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2.5 mb-3">
                                        <button
                                            ...
                                            className={`px-4 py-2 border font-mono text-[11px] font-medium rounded-lg transition-all ${logoMethod === 'url' ? 'bg-yellow-400 border-yellow-400 text-black font-bold shadow-md shadow-yellow-400/5' : 'bg-gray-50 dark:bg-[#131316] border-gray-200 dark:border-zinc-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}`}
                                        >
                                            URL Link
                                        </button>
                                        <button
                                            ...
                                            className={`px-4 py-2 border font-mono text-[11px] font-medium rounded-lg transition-all ${logoMethod === 'upload' ? 'bg-yellow-400 border-yellow-400 text-black font-bold shadow-md shadow-yellow-400/5' : 'bg-gray-50 dark:bg-[#131316] border-gray-200 dark:border-zinc-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}`}
                                        >
                                            Upload File
                                        </button>
                                    </div>
                                    ...
                                    {logoMethod === 'url' ? (
                                        <div className="flex gap-3">
                                            ...
                                            <div className="w-11 h-11 md:w-12 md:h-12 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-[#131316] flex items-center justify-center shrink-0 overflow-hidden relative">
                                                {previewUrl ? (
                                        ...
                                        <div className="flex gap-3">
                                            <div className="relative flex-1">
                                                ...
                                                />
                                                <div className="w-full px-4 py-3 text-xs bg-gray-50 dark:bg-[#131316] border border-gray-200 dark:border-zinc-800 rounded-lg flex items-center justify-between">
                                                    <span className="text-gray-600 dark:text-gray-400 truncate max-w-[200px] sm:max-w-xs">{fileInputRef.current?.files?.[0]?.name || "Select image file..."}</span>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 border-b border-gray-200 dark:border-zinc-800 pb-3">
                                    ...
                                    <div>
                                        <h2 className="font-heading text-sm font-bold uppercase tracking-wider text-gray-900 dark:text-white">Deal Configuration</h2>
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 text-left border rounded-lg transition-all group flex flex-col items-start gap-1.5 ${
                                                        isSelected
                                                            ...
                                                            : 'bg-gray-50 dark:bg-[#131316] border-gray-200 dark:border-zinc-800/80 hover:border-gray-300 dark:hover:border-zinc-700 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
                                                    }`}
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className={`block font-sans text-[8px] mt-0.5 leading-tight ${isSelected ? 'text-black/70' : 'text-gray-500 dark:text-gray-500'}`}>{cat.desc}</span>
                                                    </div>
                                                </button>
                                            )
                                        })}
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2.5 mb-3">
                                        <button
                                            ...
                                            className={`px-4 py-2 border font-mono text-[11px] font-medium rounded-lg transition-all ${redemptionMethod === 'link' ? 'bg-yellow-400 border-yellow-400 text-black font-bold shadow-md shadow-yellow-400/5' : 'bg-gray-50 dark:bg-[#131316] border-gray-200 dark:border-zinc-800 text-gray-600 dark:text-gray-400 hover:text-white'}`}
                                        >
                                            Unique URL Link
                                        </button>
                                        <button
                                            ...
                                            className={`px-4 py-2 border font-mono text-[11px] font-medium rounded-lg transition-all ${redemptionMethod === 'code' ? 'bg-yellow-400 border-yellow-400 text-black font-bold shadow-md shadow-yellow-400/5' : 'bg-gray-50 dark:bg-[#131316] border-gray-200 dark:border-zinc-800 text-gray-600 dark:text-gray-400 hover:text-white'}`}
                                        >
                                            Coupon Code
                                        </button>
                                    </div>
                            ...
                            <div className="bg-gray-50 dark:bg-[#111114] border border-gray-200 dark:border-zinc-800/80 rounded-xl p-5 hover:border-gray-300 dark:hover:border-zinc-700 transition-all">
                                <label className="flex items-start gap-3.5 cursor-pointer select-none">
                                    <input name="is_exclusive" type="checkbox" className="mt-0.5 w-5 h-5 rounded accent-yellow-400 bg-gray-50 dark:bg-[#131316] border border-gray-200 dark:border-zinc-800 cursor-pointer shrink-0" required />
                                    <div>
                                        <span className="font-mono text-xs font-bold uppercase tracking-wider text-gray-900 dark:text-white block">Exclusivity Commitment *</span>
                                        <span className="font-sans text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed block mt-1.5">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 border-b border-gray-200 dark:border-zinc-800 pb-3">
                                    ...
                                    <div>
                                        <h2 className="font-heading text-sm font-bold uppercase tracking-wider text-gray-900 dark:text-white">Listing Tier</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-mono text-xs font-bold uppercase tracking-wider text-gray-900 dark:text-white">Standard</span>
                                                </div>
                                                <span className="font-mono text-sm font-bold text-gray-600 dark:text-gray-400">FREE</span>
                                            </div>
                                            <p className="font-sans text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                                                List your startup perk chronologically below the featured directory. Reviewed in ~48 hours.
                                            </p>
                                        </div>
                                        <div className="border-t border-gray-200 dark:border-zinc-800/80 pt-3 text-[10px] font-mono text-gray-500 uppercase tracking-wider">
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className="font-mono text-sm font-bold text-gray-900 dark:text-white">{featuredPrice}</span>
                                                </div>
                                            </div>
                                            <p className="font-sans text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                                        ...
                                        <div className="border-t border-gray-200 dark:border-zinc-800/80 pt-3 space-y-1">
                                            <div className="text-[10px] font-mono text-yellow-400/80 uppercase tracking-wider">
                                                · Pinned placement for {featuredDuration}
                                            </div>
                                            <div className="text-[10px] font-mono text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                ...
                                {tier === 'featured' && (
                                    <div className="bg-gray-50 dark:bg-[#111114] border border-gray-200 dark:border-zinc-800 rounded-xl p-5 space-y-4">
                                        <p className="font-mono text-[10px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-400">Duration Option</p>
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                className={`p-3 text-left border rounded-lg transition-all flex flex-col justify-between ${
                                                    featuredPlan === 'weekly'
                                                        ? 'bg-yellow-50/20 dark:bg-[#161614] border-yellow-400 text-yellow-600 dark:text-yellow-400'
                                                        : 'bg-white dark:bg-[#131316] border-gray-200 dark:border-zinc-800/80 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
                                                }`}
                                            >
                                                <span className="font-mono text-[10px] font-bold uppercase tracking-wider">7 Days</span>
                                                <span className="font-mono text-sm font-bold text-gray-900 dark:text-white mt-1">$25</span>
                                            </button>
                                            <button
                                                type="button"
                                            ...
                                            >
                                                ...
                                                <span className="font-mono text-sm font-bold text-gray-900 dark:text-white mt-1">$99</span>
                                            </button>
                                        </div>
                                        <div className="font-sans text-[11px] text-gray-600 dark:text-gray-400 bg-yellow-400/5 border border-yellow-400/10 rounded-lg p-3.5 leading-relaxed flex gap-2">
                                ...
                                <div className="bg-gray-50 dark:bg-[#111114] border border-gray-200 dark:border-zinc-800 p-4 rounded-xl flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <input
                                            ...
                                            inputMode="numeric"
                                            placeholder="?"
                                            className={`w-16 p-2 text-sm bg-white dark:bg-[#131316] border rounded-lg text-center font-mono font-bold text-gray-900 dark:text-white focus:outline-none transition-all ${isHuman ? 'border-green-500 shadow-md shadow-green-500/10' : 'border-gray-200 dark:border-zinc-800 focus:border-yellow-400'}`}
                                    ...
                                    className={`w-full font-mono font-bold text-xs uppercase tracking-wider py-4 rounded-lg flex items-center justify-center gap-2 transition-all ${
                                        isHuman && !isSubmitting
                                            ? 'bg-yellow-400 text-black hover:bg-yellow-500 active:scale-[0.99] cursor-pointer shadow-lg shadow-yellow-400/5'
                                             : 'bg-zinc-200 dark:bg-zinc-800 text-zinc-400 dark:text-zinc-500 cursor-not-allowed border border-zinc-200 dark:border-zinc-800'
                                    }`}
                                >
